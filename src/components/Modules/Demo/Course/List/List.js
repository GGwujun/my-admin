	...
	methods: {
		...
		onEditArticle(article) {
			if (article && article._id) {
				this.$router.push('/demo/course/edit?id=' + article._id);
			} else {
				this.$message({
					showClose: true,
					message: 'ID跑哪去了？',
		...
		onAddChild(article) {
			if (article && article._id) {
				this.$router.push('/demo/course/edit?pid=' + article._id+'&pName='+article.title);
			} else {
				this.$message({
					showClose: true,
					message: 'ID跑哪去了？',
		...
		getList({
			...
			this.$$api_course_selectCourse(data, (article_data) => {
