        ...
        <el-table border style="width: 100%" align='center' :data="article_list" @selection-change='onSelectionChange'>
            ...
            <el-table-column label="操作" width="180" :context="_self">
                <template scope='scope'>
                    <el-tooltip class="item" effect="dark" content="查看课程" placement="bottom">
                    ...
                    <el-tooltip class="item" effect="dark" content="添加子课程" placement="bottom"  v-if="scope.row.pid==='0'?true:false">
                        <el-button type="info" icon='plus' size="mini"  @click='onAddChild(scope.row)'></el-button>
                    </el-tooltip>
                </template>
            </el-table-column>
        </el-table>
