<template>
    <div class="form">
        <el-form label-width="100px" style="margin:20px;width:90%;min-width:600px;" :model="article_data" :rules="rules" ref='refArticle'>
            <el-form-item label="分类名称" prop='className' style="width:600px;">
                <el-input v-model="article_data.className"></el-input>
            </el-form-item>
 
            <el-form-item  label="分类id" prop='classId' style="width:600px;">
                <el-input v-model="article_data.classId"></el-input>
            </el-form-item>
